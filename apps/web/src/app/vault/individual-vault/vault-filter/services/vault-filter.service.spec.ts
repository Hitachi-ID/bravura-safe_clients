...
describe("vault filter service", () => {
  ...
  describe("organizations", () => {
    ...
    it("returns 1 team and My Vault if single team policy is enabled", async () => {
    ...
    it("returns 1 team if both single team and personal ownership policies are enabled", async () => {
      policyService.policyAppliesToUser.calledWith(PolicyType.SingleOrg).mockResolvedValue(true);
      policyService.policyAppliesToUser
        .calledWith(PolicyType.PersonalOwnership)
        .mockResolvedValue(true);
  ...
  describe("folders", () => {
    describe("filtered folders with team", () => {
      beforeEach(() => {
      ...
      it("returns folders filtered by current team", async () => {
        const storedCiphers = [
  ...
  describe("collections", () => {
    describe("filtered collections", () => {
      it("returns collections filtered by current team", async () => {
        vaultFilterService.setOrganizationFilter(createOrganization("org test id", "Test Org"));
