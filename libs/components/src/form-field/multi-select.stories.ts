...
Collections.args = {
  ...
  baseItems: [
    { id: "1", listName: "Collection 1", labelName: "Collection 1", icon: "fa-collection" },
    { id: "2", listName: "Collection 2", labelName: "Collection 2", icon: "fa-collection" },
    { id: "3", listName: "Collection 3", labelName: "Collection 3", icon: "fa-collection" },
    {
      id: "3.5",
    ...
    { id: "4", listName: "Collection 4", labelName: "Collection 4", icon: "fa-collection" },
    { id: "5", listName: "Collection 5", labelName: "Collection 5", icon: "fa-collection" },
    { id: "6", listName: "Collection 6", labelName: "Collection 6", icon: "fa-collection" },
    { id: "7", listName: "Collection 7", labelName: "Collection 7", icon: "fa-collection" },
  ],
};
