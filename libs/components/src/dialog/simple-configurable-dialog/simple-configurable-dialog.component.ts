...
const DEFAULT_ICON: Record<SimpleDialogType, string> = {
  [SimpleDialogType.PRIMARY]: "fa-business",
  [SimpleDialogType.SUCCESS]: "fa-star",
  [SimpleDialogType.INFO]: "fa-info-circle",
  [SimpleDialogType.WARNING]: "fa-exclamation-triangle",
  [SimpleDialogType.DANGER]: "fa-error",
};
