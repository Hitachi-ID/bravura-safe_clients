...
import { UpdateTwoFactorHyprRequest } from "../auth/models/request/update-two-factor-hypr.request";
...
import { TwoFactorHyprResponse } from "../auth/models/response/two-factor-hypr.response";
import { TwoFactorHyprAuthResponse } from "../auth/models/response/two-factor-hypr-auth.response";
...
import { TwoFactorHyprAuthGetMagicLink } from "../auth/models/response/two-factor-hypr-auth-get-magic-link.response";
...
export class ApiService implements ApiServiceAbstraction {
  ...
  async preValidateSso(identifier: string): Promise<SsoPreValidateResponse> {
    if (identifier == null || identifier === "") {
      throw new Error("Team Identifier was not provided.");
    }
    const headers = new Headers({
      Accept: "application/json",
      "Device-Type": this.deviceType,
