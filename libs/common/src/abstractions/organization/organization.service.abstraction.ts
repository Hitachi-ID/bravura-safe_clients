...
export function canAccessReportsTab(org: Organization): boolean {
  return org.canAccessReports;
}

export function canAccessToolsTab(org: Organization): boolean {
  return org.canAccessImportExport;
}
...
export function canAccessOrgAdmin(org: Organization): boolean {
  return canAccessReportsTab(org) || canAccessToolsTab(org) || canAccessSettingsTab(org) || canAccessManageTab(org);
}
